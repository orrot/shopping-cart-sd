...
class CountCartItemsUseCaseTest {
    ...
    class WhenCountingItemsInCart {
        ...
        void shouldReturnCountOfItemsInCart() {
            ...
            Long count = countCartItemsUseCase.countCartItems(DEFAULT_CART_ID);
        ...
        void shouldThrowExceptionIfCartDoesNotExist() {
            ...
            assertThatThrownBy(() -> countCartItemsUseCase.countCartItems(DEFAULT_CART_ID))
